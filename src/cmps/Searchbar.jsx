            ...
            <form action="" className="flex search-bar" onSubmit={onSubmit}>
                ...
                <div className='input-container flex'>
                    <label htmlFor="checkIn">
                        <div>Check in</div>
                        <input type="text" id="checkIn" placeholder="Add dates" name='checkIn' value={filterByToEdit.checkIn} onChange={onHandleChange}/>
                    </label>
                ...
                <div className='input-container flex'>
                    <label htmlFor="checkOut">
                        <div>Check out</div>
                        <input type="text" id="checkOut" placeholder="Add dates" name='checkOut' value={filterByToEdit.checkOut} onChange={onHandleChange}/>
                    </label>
